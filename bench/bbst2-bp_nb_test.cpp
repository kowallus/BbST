...
int main(int argc, char**argv) {
...
#ifdef QUANTIZED
    fstream fout("cBbST2-BP_nb_res.txt", ios::out | ios::binary | ios::app);
#else
    fstream fout("BbST2-BP_nb_res.txt", ios::out | ios::binary | ios::app);
#endif
    ...
    if (verbose) cout << "Building BbST2-FN... " << std::endl;
    timer.startTimer();
